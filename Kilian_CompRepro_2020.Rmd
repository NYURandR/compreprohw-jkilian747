...
Hello. Wilson et. al. suggest under "Data Management" that all steps used to process data should be recorded. Programs like R are useful because they allow for steps to be recorded and easily accessible. This allows for ethical data manipulation to occur.
